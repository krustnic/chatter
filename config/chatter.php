...
return [
    ...
    */
    ...
    'messages' => [
        'alerts' => [
            'prevent_spam' => 'В качестве борьбы со спамом установлено минимально возможное время между комментариями: ',
            'discussion_created' => 'Обсуждение успешно создано.',
            'discussion_creation_problem' => 'При создании обсуждения возникла ошибка.',
            'comment_created' => 'Комментарий успешно создан.',
            'comment_creation_problem' => 'При создании комментария произошла ошибка.',
            'discussion_updated' => 'Обсуждение обновлено.',
            'discussion_update_error' => 'При обновлении произошла ошибка.',
            'discussion_removed' => 'Обсуждение успешно удалено.',
            'comment_removed' => 'Комментарий успешно удален.',
            'comment_remove_error' => 'При удалении комментария произошла ошибка.'
        ]
    ],
